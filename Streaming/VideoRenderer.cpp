...
VideoRenderer::VideoRenderer(const std::shared_ptr<DX::DeviceResources>& deviceResources, std::shared_ptr<MoonlightClient> mclient, StreamConfiguration^ sConfig) :
